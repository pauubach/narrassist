...
class TestIssue02_03EntityFusionTypes:
    ...
    def test_types_compatible_concept_character_with_names(self, fusion_service):
        ...
        e1 = Entity(
            id=1, canonical_name="María Sánchez", entity_type=EntityType.CHARACTER, project_id=1
        )
        e2 = Entity(
            id=2,
        ...
        e3 = Entity(
            id=3, canonical_name="algo extraño", entity_type=EntityType.CONCEPT, project_id=1
        )
...
class TestIntegrationValidatorPatterns:
    ...
    def test_sensory_exclusion_patterns_compile(self):
        ...
        for i, pattern in enumerate(SENSE_EXCLUSION_PATTERNS):
            assert hasattr(pattern, "search"), f"Pattern {i} debe ser un patrón regex compilado"
