...
class TestSemanticPragmaticAttribution:
    ...
    @pytest.mark.parametrize("case", SEMANTIC_PRAGMATIC_TEST_CASES, 
                            ids=[c.id for c in SEMANTIC_PRAGMATIC_TEST_CASES])
    ...
    @pytest.mark.parametrize("case", [CASO_1_NEGACION, CASO_2_NEGACION_TEMPORAL],
                            ids=["NEGACION_001", "NEGACION_002"])
    ...
    @pytest.mark.parametrize("case", [CASO_3_METAFORA_OJOS, CASO_4_METAFORA_PERSONALIDAD],
    ...
    @pytest.mark.parametrize("case", [CASO_5_TEMPORAL],
                            ids=["TEMPORAL_005"])
    ...
    @pytest.mark.parametrize("case", [CASO_6_CONDICIONAL],
                            ids=["CONDICIONAL_006"])
    ...
    @pytest.mark.parametrize("case", [CASO_8_INFERENCIA_LEXICA],
                            ids=["INFERENCIA_008"])
    ...
    @pytest.mark.parametrize("case", [CASO_9_CONTRADICCION],
                            ids=["CONTRADICCION_009"])
    ...
    @pytest.mark.parametrize("case", [CASO_11_IRONIA],
                            ids=["IRONIA_011"])
