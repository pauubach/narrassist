...
class TestComplexAttributes:
    ...
    THIRD_PARTY_ATTRIBUTES = [
        ...
        ("El padre de María, un hombre corpulento, entró.", "corpulento", "padre de María", "María"),
...
class TestAmbiguousTemporalMarkers:
    ...
    def test_implicit_flashback_by_date(self, text):
        ...
        pytest.xfail("Flashback implícito por cambio de fecha - requiere análisis temporal avanzado")
...
class TestNonStandardDialogue:
    ...
    def test_saramago_style_dialogue(self):
        ...
        pytest.xfail("Estilo Saramago: diálogos sin puntuación estándar - requiere heurísticas especiales")
...
class TestImplicitRelationships:
    ...
    IMPLICIT_RELATIONS = [
        (
            ...
            "María", "Juan", "madre-hijo", "implícito por 'su hijo'"
        ),
        (
            "Pedro y Ana celebraban. Veinte años de casados no eran poca cosa.",
            "Pedro", "Ana", "esposos", "implícito por 'casados'"
        ),
        (
            "—Papá, ¿puedo ir? —preguntó Luis.\n—No —respondió Carlos.",
            "Luis", "Carlos", "hijo-padre", "implícito por 'Papá'"
        ),
    ]
