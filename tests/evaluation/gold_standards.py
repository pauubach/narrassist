...
GOLD_INCONSISTENCIAS_PERSONAJES = GoldStandard(
    ...
    entities=[
        GoldEntity("Maria Sanchez", "PER", ["Maria", "María", "Maria Sanchez", "María Sánchez", "MARIA"]),
    ...
    attributes=[
        ...
        GoldAttribute("Maria", "cabello", ["negro largo", "rubio", "castano largo"], [1, 1, 3], is_inconsistency=True),
        GoldAttribute("Maria", "estatura", ["alta", "baja"], [1, 2], is_inconsistency=True),
        GoldAttribute("Maria", "profesion", ["profesora de literatura", "matematicas"], [1, 2], is_inconsistency=True),
        ...
        GoldAttribute("Juan", "profesion", ["carpintero", "abogado"], [1, 5], is_inconsistency=True),
        GoldAttribute("Pedro", "ojos", ["verdes", "azules"], [2, 3], is_inconsistency=True),
        GoldAttribute("Elena", "cabello", ["pelirroja", "negro tenido rubio"], [3, 5], is_inconsistency=True),
    ],
...
GOLD_TIMELINE_EVENTOS = GoldStandard(
    ...
    events=[
        # Capitulo 1: 1990
        GoldEvent("Nacimiento de Maria", 1, 1, ["Maria", "Pedro", "Carmen"], ["15 de enero de 1990"]),
        GoldEvent("Mudanza a Madrid", 1, 2, ["Maria", "Pedro", "Carmen"], ["Tres meses despues", "Abril 1990"]),
        ...
        GoldEvent("18 cumpleanos", 3, 4, ["Maria"], ["15 de enero de 2008", "dieciocho cumpleanos"]),
        ...
        GoldEvent("Nacimiento de Ana", 5, 3, ["Maria", "Carlos", "Ana", "Pablo"], ["2018", "Tres anos mas tarde"]),
...
GOLD_UNSEEN_CIENCIA_FICCION = GoldStandard(
    ...
    entities=[
        ...
        GoldEntity("Tomas Villanueva", "PER", ["Tomas Villanueva", "Tomás Villanueva", "Tomas", "Tomás"]),
        GoldEntity("Lucia Mendoza", "PER", ["Lucia Mendoza", "Lucía Mendoza", "Lucia", "Lucía"]),
        GoldEntity("Fernando Ramirez", "PER", ["Fernando Ramirez", "Fernando Ramírez", "Ramirez", "Ramírez", "doctor Ramirez", "doctor Ramírez"]),
        GoldEntity("Chen Wei", "PER", ["Chen Wei", "Chen"]),
        GoldEntity("Rosa Guerrero", "PER", ["Rosa Guerrero", "Rosa"]),
        GoldEntity("Hector Salgado", "PER", ["Hector Salgado", "Héctor Salgado", "coronel Salgado"]),
        # Ubicaciones
...
GOLD_UNSEEN_NOVELA_HISTORICA = GoldStandard(
    ...
    entities=[
        # Personas
        GoldEntity("Fray Alonso de Guzman", "PER", ["Fray Alonso de Guzman", "Fray Alonso de Guzmán", "Fray Alonso", "Alonso"]),
        GoldEntity("Isaac Benveniste", "PER", ["Isaac Benveniste", "Isaac", "doctor Benveniste"]),
        GoldEntity("Francisco Jimenez de Cisneros", "PER", ["Francisco Jimenez de Cisneros", "Francisco Jiménez de Cisneros", "cardenal Cisneros", "Cisneros"]),
        GoldEntity("Fernando", "PER", ["Fernando"]),
        GoldEntity("Isabel", "PER", ["Isabel"]),
        GoldEntity("Beatriz de Bobadilla", "PER", ["Beatriz de Bobadilla", "Dona Beatriz de Bobadilla", "Doña Beatriz de Bobadilla"]),
        GoldEntity("Raquel", "PER", ["Raquel"]),
        GoldEntity("David", "PER", ["David"]),
        GoldEntity("Miriam", "PER", ["Miriam"]),
        GoldEntity("Vasco Goncalves", "PER", ["Vasco Goncalves", "Vasco Gonçalves", "capitan Goncalves", "capitán Gonçalves"]),
...
GOLD_UNSEEN_THRILLER = GoldStandard(
    ...
    entities=[
        # Personas
        GoldEntity("Monica Salazar", "PER", ["Monica Salazar", "Mónica Salazar", "Monica", "Mónica", "inspectora Salazar"]),
        GoldEntity("Andres Riquelme", "PER", ["Andres Riquelme", "Andrés Riquelme", "subinspector Riquelme"]),
        GoldEntity("Cristina Vega", "PER", ["Cristina Vega", "doctora Vega"]),
        GoldEntity("Sergio Blanco", "PER", ["Sergio Blanco", "Sergio"]),
        GoldEntity("Rodrigo Santamaria", "PER", ["Rodrigo Santamaria", "Rodrigo Santamaría", "Santamaria", "Santamaría"]),
        ...
        GoldEntity("Ignacio Bermudez", "PER", ["Ignacio Bermudez", "Ignacio Bermúdez", "juez Bermudez", "juez Bermúdez"]),
        ...
        GoldEntity("Barcelona", "LOC", ["Barcelona"]),
        # Organizaciones
        GoldEntity("Fiscalia Anticorrupcion", "ORG", ["Fiscalia Anticorrupcion", "Fiscalía Anticorrupción"]),
...
GOLD_UNSEEN_FANTASIA = GoldStandard(
    ...
    entities=[
        ...
        GoldEntity("Selene Corazondeoro", "PER", ["Selene Corazondeoro", "Selene Corazóndeoro", "Selene", "princesa Selene"]),
        GoldEntity("Brennan Escudoacero", "PER", ["Brennan Escudoacero", "Brennan", "sir Brennan", "principe Brennan", "príncipe Brennan"]),
        ...
        GoldEntity("Thorin Martillopesado", "PER", ["Thorin Martillopesado", "Thorin", "maestro Thorin"]),
...
GOLD_UNSEEN_TERROR = GoldStandard(
    ...
    entities=[
        # Personas
        GoldEntity("Samuel Thornton", "PER", ["Samuel Thornton", "doctor Thornton", "doctor Samuel"]),
        GoldEntity("Victoria Blackwood", "PER", ["Victoria Blackwood", "senora Victoria", "señora Victoria", "Victoria"]),
        GoldEntity("Edmund Blackwood", "PER", ["Edmund Blackwood", "lord Edmund", "senor Blackwood", "señor Blackwood", "Edmund"]),
        ...
        # Ubicaciones
        GoldEntity("Mansion Blackwood", "LOC", ["Mansion Blackwood", "Mansión Blackwood", "ala este"]),
    ],
)
...
GOLD_UNSEEN_AVENTURAS = GoldStandard(
    ...
    entities=[
        # Personas
        GoldEntity("Jack Redbeard", "PER", ["Jack Redbeard", "capitan Redbeard", "capitán Redbeard", "capitan Jack", "capitán Jack"]),
        GoldEntity("Miguel Salinas", "PER", ["Miguel Salinas", 'Miguel "El Cuervo" Salinas', "El Cuervo", "Miguel"]),
        GoldEntity("Isabella Marquez", "PER", ["Isabella Marquez", "Isabella Márquez", "Isabella"]),
        GoldEntity("Diego Marquez", "PER", ["Diego Marquez", "Diego Márquez", "capitan Diego", "capitán Diego"]),
        GoldEntity("Francisco Moreno", "PER", ["Francisco Moreno", "almirante Moreno"]),
        GoldEntity("Sebastian de Cordoba", "PER", ["Sebastian de Cordoba", "Sebastián de Córdoba", "don Sebastian", "don Sebastián"]),
        GoldEntity("Hernando Ruiz", "PER", ["Hernando Ruiz", "capitan Hernando", "capitán Hernando"]),
        GoldEntity("Tomas Vasquez", "PER", ["Tomas Vasquez", "Tomás Vásquez", 'Tomas "Trueno" Vasquez', "Tomas", "Tomás", "Trueno"]),
        GoldEntity("Maria Santos", "PER", ["Maria Santos", "María Santos", 'Maria "La Bruja" Santos', "Maria", "María", "La Bruja"]),
        GoldEntity("Valentina Cordoba", "PER", ["Valentina Cordoba", "Valentina Córdoba", "Valentina"]),
        GoldEntity("Alejandro Montes", "PER", ["Alejandro Montes", "arqueologo Montes", "arqueólogo Montes"]),
        GoldEntity("Rodrigo Beltran", "PER", ["Rodrigo Beltran", "Rodrigo Beltrán", "profesor Beltran", "profesor Beltrán"]),
        GoldEntity("William Thompson", "PER", ["William Thompson", 'William "Billy" Thompson', "Billy", "William"]),
...
GOLD_UNSEEN_DRAMA = GoldStandard(
    ...
    entities=[
        ...
        GoldEntity("Mercedes Villaverde", "PER", ["Mercedes Villaverde", "dona Mercedes", "doña Mercedes"]),
        ...
        GoldEntity("Sofia Sotomayor", "PER", ["Sofia Sotomayor Villaverde", "Sofía Sotomayor Villaverde", "Sofia", "Sofía"]),
        ...
        GoldEntity("Ramon Villaverde", "PER", ["Ramon Villaverde", "Ramón Villaverde", "tio Ramon", "tío Ramón"]),
...
GOLD_MULETILLAS_DIALOGOS = GoldStandard(
    ...
    entities=[
        ...
        GoldEntity("Fernando Gutierrez", "PER", ["Fernando", "Fernando Gutierrez", "senor Gutierrez"]),
        GoldEntity("Marcos", "PER", ["Marcos"]),
...
GOLD_MULETILLAS_DATA = {
    "muletillas_dialogos": {
        "Rosa": {"pues": 15, "o sea": 12, "eh": 4, "bueno": 6, "vamos": 2, "la verdad": 2, "no se": 3},
...
GOLD_DIALOGUES_DATA = {
    "muletillas_dialogos": [
        ...
        GoldDialogue("Ya, bueno, pues nada, que mola mucho verte asi, o sea, toda profesional y eso.", "Marcos", 3),
        GoldDialogue("Excelente presentacion, senorita Martinez. Sus metricas eran impecables", "Fernando", 3),
        ...
        GoldDialogue("Ya sabes como es tu hermano. Siempre ha sido muy, como decirlo, espontaneo.", "Carmen", 4),
        GoldDialogue("Si, bueno, es que... no se, a veces me gustaria que fuera mas, pues, mas profesional.", "Rosa", 4),
        GoldDialogue("Hija, cada uno es como es. Tu eres de una manera en el trabajo y de otra en casa.", "Carmen", 4),
...
GOLD_CORREFERENCIAS_COMPLEJAS = GoldStandard(
    ...
    entities=[
        ...
        GoldEntity("La casa Garcia", "LOC", ["la vieja casa", "la casa", "la propiedad", "esta casa"]),
    ],
    ...
    coreferences=[
        GoldCoreference("Miguel Garcia", ["Miguel", "el mayor", "El", "hermanito", "el"], [1, 2, 3, 4, 5]),
        GoldCoreference("Sofia Garcia", ["Sofia", "Su hermana", "Ella", "ella"], [1, 2, 3, 4, 5]),
        GoldCoreference("Pedro Garcia", ["Pedro", "el mediano", "el ultimo", "el", "su hermano menor"], [1, 2, 3, 4, 5]),
        GoldCoreference("dona Carmen", ["La madre de los tres", "dona Carmen", "Ella", "el pegamento"], [3]),
        GoldCoreference("don Antonio", ["su padre", "El padre", "don Antonio", "El", "papa"], [2, 3, 5]),
        GoldCoreference("La casa Garcia", ["la vieja casa", "la casa", "Esta", "la propiedad", "esta casa"], [1, 2, 4, 5]),
    ],
