...
function transformRegisterAnalysis(api: ApiRegisterAnalysis): RegisterAnalysis {
  return {
    ...
    primaryRegister: api.primary_register as RegisterType,
    registerScores: api.register_scores as Record<RegisterType, number>,
    confidence: api.confidence,
...
function transformRegisterChange(api: ApiRegisterChange): RegisterChange {
  return {
    fromRegister: api.from_register as RegisterType,
    toRegister: api.to_register as RegisterType,
    severity: api.severity as ChangeSeverity,
...
function transformDialogueAttribution(api: ApiDialogueAttribution): DialogueAttribution {
  return {
    ...
    confidence: api.confidence as AttributionConfidence,
    method: api.method as AttributionMethod,
...
function transformKnowledgeFact(api: ApiKnowledgeFact): KnowledgeFact {
  return {
    ...
    knowledgeType: api.knowledge_type as KnowledgeType,
