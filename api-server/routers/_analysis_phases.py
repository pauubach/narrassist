    ...
    try:
        ...
        for idx, entity in enumerate(entities, start=1):
            ...
            if idx % importance_update_every == 0 or idx == total_entities_for_importance:
                ...
                _update_fusion_progress(
                    0.96 + importance_fraction * 0.025,
...
def run_grammar(ctx: dict, tracker: ProgressTracker):
    """Fase 8: An?lisis gramatical y correcciones editoriales."""
    run_grammar_phase(
        ctx,
        tracker,
        logger=logger,
        to_optional_int=_to_optional_int,
        find_chapter_number_for_position=_find_chapter_number_for_position,
    )
