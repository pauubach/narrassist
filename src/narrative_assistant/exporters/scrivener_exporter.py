...
class ScrivenerExporter:
    ...
    def export(
        ...
        options: Optional[ScrivenerExportOptions] = None,
    ) -> Result[bytes]:
        """
        ...
        try:
            ...
            with zipfile.ZipFile(buffer, "w", zipfile.ZIP_DEFLATED) as zf:
                ...
                for item in chapter_items:
                    ...
                    zf.writestr(
                        f"{scriv_name}/Files/Data/{item['uuid']}/content.rtf",
                        rtf_content
                    )
                    ...
                    if options.include_alerts_as_notes and item.get("alerts"):
                        ...
                        zf.writestr(
                            f"{scriv_name}/Files/Data/{item['uuid']}/notes.rtf",
                            notes_rtf
                        )

                    # Synopsis
                    if options.include_synopsis and item.get("synopsis"):
                        synopsis_rtf = self._text_to_rtf(item["synopsis"])
                        zf.writestr(
                            f"{scriv_name}/Files/Data/{item['uuid']}/synopsis.txt",
                            item["synopsis"]
                        )
...
def export_to_scrivener(
    ...
    try:
        ...
        for ch in chapters:
            ...
            export_data.chapters.append(ScrivenerChapter(
        ...
        for entity in entities:
            ...
            if etype in ("CHARACTER", "PERSON", "PER"):
                ...
                export_data.characters.append(ScrivenerCharacter(
