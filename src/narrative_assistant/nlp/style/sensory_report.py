...
class ChapterSensoryStats:
    ...
    by_sense: dict = field(default_factory=lambda: {
        SensoryType.SIGHT: 0,
    ...
    dominant_sense: Optional[SensoryType] = None
...
class SensoryReport:
    ...
    # Desequilibrio
    dominant_sense: Optional[SensoryType] = None
    weakest_sense: Optional[SensoryType] = None
    ...
    def to_dict(self) -> dict:
        return {
            ...
            "sense_percentages": {
                s.value: round(p, 1)
                for s, p in self.sense_percentages.items()
            },
            "dominant_sense": self.dominant_sense.value if self.dominant_sense else None,
...
SIGHT_KEYWORDS: dict[str, float] = {
    # Verbos
    "ver": 0.7, "mirar": 0.9, "observar": 0.9, "contemplar": 0.9,
    "vislumbrar": 0.95, "avistar": 0.95, "divisar": 0.95,
    "atisbar": 0.95, "otear": 0.95, "distinguir": 0.7,
    "brillar": 0.9, "relucir": 0.95, "resplandecer": 0.95,
    "centellear": 0.95, "destellar": 0.95, "fulgurar": 0.95,
    "parpadear": 0.8, "pestañear": 0.8, "enfocar": 0.8,
    # Colores
    "rojo": 0.9, "azul": 0.9, "verde": 0.9, "amarillo": 0.9,
    "blanco": 0.85, "negro": 0.85, "gris": 0.85, "rosa": 0.85,
    "morado": 0.9, "violeta": 0.9, "naranja": 0.85, "marrón": 0.9,
    "dorado": 0.9, "plateado": 0.9, "carmesí": 0.95,
    "escarlata": 0.95, "púrpura": 0.95, "turquesa": 0.95,
    "esmeralda": 0.95, "ocre": 0.95, "ámbar": 0.95,
    "bermellón": 0.95, "índigo": 0.95, "cobalto": 0.95,
    # Luz y oscuridad
    "luz": 0.85, "sombra": 0.85, "oscuridad": 0.9, "penumbra": 0.95,
    "brillo": 0.9, "destello": 0.95, "resplandor": 0.95,
    "fulgor": 0.95, "luminosidad": 0.95, "tinieblas": 0.95,
    "claroscuro": 0.95, "reflejo": 0.85, "silueta": 0.9,
    # Adjetivos visuales
    "luminoso": 0.9, "oscuro": 0.85, "brillante": 0.9,
    "opaco": 0.9, "transparente": 0.9, "translúcido": 0.95,
    "nítido": 0.9, "borroso": 0.9, "difuso": 0.85,
    "vívido": 0.9, "pálido": 0.85, "intenso": 0.7,
    "radiante": 0.9, "tenue": 0.85, "sombrío": 0.9,
}

# Oído: verbos, adjetivos, sustantivos relacionados con oír
HEARING_KEYWORDS: dict[str, float] = {
    # Verbos
    "oír": 0.9, "escuchar": 0.9, "sonar": 0.9,
    "resonar": 0.95, "retumbar": 0.95, "tronar": 0.9,
    "murmurar": 0.9, "susurrar": 0.95, "gritar": 0.85,
    "aullar": 0.9, "rugir": 0.9, "silbar": 0.9,
    "zumbar": 0.95, "crujir": 0.95, "chirriar": 0.95,
    "chasquear": 0.95, "tintinear": 0.95, "repicar": 0.95,
    "cantar": 0.8, "tararear": 0.9, "gemir": 0.8,
    # Sustantivos
    "sonido": 0.9, "ruido": 0.9, "silencio": 0.85,
    "estruendo": 0.95, "estrépito": 0.95, "fragor": 0.95,
    "murmullo": 0.95, "susurro": 0.95, "grito": 0.85,
    "eco": 0.9, "melodía": 0.9, "música": 0.85,
    "rumor": 0.85, "aullido": 0.9, "rugido": 0.9,
    "chasquido": 0.95, "crujido": 0.95, "estallido": 0.9,
    "zumbido": 0.95, "campanada": 0.95, "trueno": 0.9,
    # Adjetivos
    "ruidoso": 0.9, "silencioso": 0.85, "estridente": 0.95,
    "atronador": 0.95, "ensordecedor": 0.95, "melodioso": 0.95,
    "chirriante": 0.95, "ronco": 0.85, "agudo": 0.7,
    "grave": 0.7, "sordo": 0.8, "gutural": 0.9,
}

# Tacto: verbos, adjetivos, sustantivos relacionados con tocar
TOUCH_KEYWORDS: dict[str, float] = {
    # Verbos
    "tocar": 0.85, "acariciar": 0.95, "rozar": 0.95,
    "palpar": 0.95, "frotar": 0.9, "rascar": 0.9,
    "apretar": 0.85, "estrechar": 0.8, "abrazar": 0.85,
    "pellizcar": 0.9, "arañar": 0.9, "masajear": 0.95,
    "temblar": 0.8, "estremecerse": 0.85, "tiritar": 0.9,
    # Temperatura
    "frío": 0.8, "calor": 0.8, "caliente": 0.85,
    "helado": 0.9, "tibio": 0.9, "templado": 0.85,
    "ardiente": 0.85, "gélido": 0.95, "cálido": 0.85,
    "fresco": 0.75, "abrasador": 0.95, "glacial": 0.95,
    # Texturas
    "suave": 0.8, "áspero": 0.9, "rugoso": 0.95,
    "liso": 0.85, "pegajoso": 0.9, "resbaladizo": 0.9,
    "aterciopelado": 0.95, "sedoso": 0.95, "granuloso": 0.95,
    "esponjoso": 0.95, "duro": 0.7, "blando": 0.8,
    "húmedo": 0.8, "seco": 0.7, "mojado": 0.8,
    "empapado": 0.85, "viscoso": 0.95, "punzante": 0.9,
    # Sustantivos
    "textura": 0.95, "tacto": 0.95, "caricia": 0.95,
    "roce": 0.95, "contacto": 0.8, "presión": 0.8,
    "escalofrío": 0.9, "hormigueo": 0.95, "cosquilleo": 0.95,
    "pinchazo": 0.9, "ardor": 0.85, "comezón": 0.95,
}

# Olfato: verbos, adjetivos, sustantivos relacionados con oler
SMELL_KEYWORDS: dict[str, float] = {
    # Verbos
    "oler": 0.95, "olfatear": 0.95, "husmear": 0.95,
    "aspirar": 0.7, "inhalar": 0.8, "apestar": 0.95,
    "perfumar": 0.95, "aromatizar": 0.95, "heder": 0.95,
    # Sustantivos
    "olor": 0.95, "aroma": 0.95, "fragancia": 0.95,
    "perfume": 0.9, "hedor": 0.95, "tufo": 0.95,
    "esencia": 0.8, "efluvio": 0.95, "emanación": 0.9,
    "fetidez": 0.95, "pestilencia": 0.95, "bocanada": 0.8,
    "vaharada": 0.95, "bouquet": 0.95,
    # Adjetivos
    "aromático": 0.95, "fragante": 0.95, "perfumado": 0.95,
    "apestoso": 0.95, "maloliente": 0.95, "fétido": 0.95,
    "pestilente": 0.95, "rancio": 0.9, "acre": 0.9,
    "oloroso": 0.95, "nauseabundo": 0.95, "almizclado": 0.95,
    # Olores específicos
    "incienso": 0.9, "alcanfor": 0.95, "azufre": 0.9,
}
...
TASTE_KEYWORDS: dict[str, float] = {
    ...
    "umami": 0.95, "insípido": 0.95, "soso": 0.85,
    # Adjetivos de sabor
    "sabroso": 0.9, "delicioso": 0.85, "empalagoso": 0.95,
    "agridulce": 0.95, "acre": 0.85, "rancio": 0.85,
    "nauseabundo": 0.8, "apetitoso": 0.9, "suculento": 0.95,
    "exquisito": 0.8, "jugoso": 0.9, "crujiente": 0.8,
    # Sustantivos
    "sabor": 0.95, "gusto": 0.85, "paladar": 0.95,
    "bocado": 0.85, "sorbo": 0.9, "trago": 0.8,
    "mordisco": 0.85, "degustación": 0.95,
}
        ...
        try:
            ...
            if chapters:
                for chapter_data in chapters:
                    ...
                    if stats.density_level == SensoryDensity.SPARSE:
                        report.sparse_chapters.append(ch_num)
                    elif stats.density_level == SensoryDensity.ABSENT:
                        report.sparse_chapters.append(ch_num)
