...
class TitleDetector:
    ...
    def detect(self, text: str) -> tuple[bool, TitleType | None, float]:
        """
    ...
    def _has_conjugated_verb(self, text: str) -> bool:
        ...
        return any(re.search(pattern, text_lower) for pattern in verb_endings)
...
class TitlePreprocessor:
    ...
    def process_with_context(
        self, text: str, preserve_titles: bool = False
