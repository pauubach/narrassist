...
class VoiceProfileBuilder:
    ...
    def _build_single_profile(
        ...
        # Calcular muletillas
        filler_counts = Counter()  # type: ignore[var-annotated]
    ...
    def _detect_speech_patterns(
        ...
        starts = Counter()  # type: ignore[var-annotated]
        for text in interventions:
        ...
        ends = Counter()  # type: ignore[var-annotated]
        for text in interventions:
        ...
        expressions = Counter()  # type: ignore[var-annotated]
        for text in interventions:
